                ...
                <form method="post" action='<c:url value="/addPlayer"/>'>
                    ...
                    <section class="mb-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="name" id="inputDefault1" name="name" required="required" pattern="[A-Za-z0-9]{1,20}">
                        </div>

                        <div class="form-group">
                            <label class="col-form-label mt-4" for="inputDefault2">last name</label>
                            <input type="text" class="form-control" placeholder="last name" id="inputDefault2" name="lastName" pattern="[A-Za-z0-9]{1,20}">
                        </div>
                    </section>
