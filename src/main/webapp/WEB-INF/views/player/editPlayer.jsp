                ...
                <form method="post" action='<c:url value="/editPlayer/${player.id}"/>'>
                    ...
                    <section class="mb-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="${player.name}" id="inputDefault1" name="name" required="required">
                        </div>

                        <div class="form-group">
                            <label class="col-form-label mt-4" for="inputDefault2">last name</label>
                            <input type="text" class="form-control" placeholder="${player.lastName}" id="inputDefault2" name="lastName" required="required">
                        </div>
                    </section>
